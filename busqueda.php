...
$listaProductos = $db->query("select p.id, primera, p.nombre, precio from producto p, categoria c, imagenes i where p.id_categoria = c.id and i.id_producto = p.id and p.nombre like '$busqueda' and estado in ('activo', 'destacado')");
$listaProductos2=$db->query("select p.id, primera, p.nombre, precio from producto p, categoria c, imagenes i where p.id_categoria = c.id and i.id_producto = p.id and p.nombre like '$busqueda' and estado in ('activo', 'destacado')");
...
<body>
	...
	<div class="contenedor-catalogo">
		...
		<h1>Busqueda: <?php echo rtrim($busqueda, "%") ?></h1>
